package br.com.centralandradina.lootchest;
 ...
 *
 */
public final class Lootchest extends JavaPlugin  implements Listener {
            ...
            if(block.getType().toString().toLowerCase().contains("wall_sign")) {
                ...
                if(blockBehindSign.getType().toString().toLowerCase().contains("chest")) {
                        ...
                        if(loot_id.length() > 0) {
                            ...
                            event.setLine(2, this.color("&4Must by the ID"));
                        }
